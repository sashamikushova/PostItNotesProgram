...
It includes 4 web pages: for signing up, logging in, saving tasks and managing push notifications. If user is subscribed they will receive task push notifications 2 minutes before the actual time of a task. The notifications are visible even if the window is closed.
